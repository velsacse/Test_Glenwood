 ...
 *
 */
public abstract class FastTogglePressElement extends Composite implements HasPressHandlers {
  ...
  public FastTogglePressElement(int msDelay) {
    this();
    if (msDelay >= 0) {
      flashDelay = msDelay;
    }
